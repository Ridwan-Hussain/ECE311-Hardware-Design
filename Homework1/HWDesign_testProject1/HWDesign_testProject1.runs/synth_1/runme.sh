...
HD_PWD='/afs/ee.cooper.edu/user/r/ridwan.hussain/Homework_1/Homework_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestProgram_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestProgram_wrapper.tcl
