...
HD_PWD='/afs/ee.cooper.edu/user/r/ridwan.hussain/HardwareDesign/Homework2/Mux6to3/Mux6to3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux6to3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux6to3.tcl -notrace
