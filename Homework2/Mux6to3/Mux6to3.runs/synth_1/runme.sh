...
HD_PWD='/afs/ee.cooper.edu/user/r/ridwan.hussain/HardwareDesign/Homework2/Mux6to3/Mux6to3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux6to3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux6to3.tcl
