...
HD_PWD='/afs/ee.cooper.edu/user/r/ridwan.hussain/Homework_1/Homework_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestProgram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestProgram_wrapper.tcl -notrace
